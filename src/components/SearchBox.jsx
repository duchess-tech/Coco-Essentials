  ...
  return (
    <AnimatePresence>
      {showProducts && searchedProducts.length > 0 && (
        <motion.div
          ref={productRef}
          className="absolute searchcase xl:top-[92px] appColor2 xl:right-[500px] xl:w-[418px] xl:max-h-[300px] pb-10 border-b-black border-3 max-h-[350px] md:right-[70px] border-2 md:w-3/4 md:top-16 w-4/5 overflow-y-auto"
...
//     <div
//       ref={productRef}
//       className="absolute  searchcase xl:top-16 bg-[#552c15] xl:right-[500px] xl:w-[418px] xl:max-h-[300px] pb-10 border-b-black border-3 max-h-[350px] md:right-[70px] border-2 md:w-3/4 md:top-16 w-4/5 overflow-y-auto "
//     >
//       <div className={`sticky top-0 w-full ${isSticky ? 'bg-[#84563B]' : 'bg-[#fadfe7]'}`} >
//         <div className="flex items-center justify-around p-4 ">
//         <MdArrowBackIos onClick={handleClickBack} size={20} />
//         <h4 className="text-center">Radiantwhispersstore</h4>
//         <div></div>
