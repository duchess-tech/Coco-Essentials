...
>
  <div className="md:h-[420px] h-[500px] w-full xl:flex lg:flex md:flex sm:flex flex sm:justify-center justify-center   bg-cover bg-center  md:bg-none bg-[url('https://res.cloudinary.com/dz6yrbkai/image/upload/v1747151905/cocoEssentialsImages/cocoModel.png')] ">
